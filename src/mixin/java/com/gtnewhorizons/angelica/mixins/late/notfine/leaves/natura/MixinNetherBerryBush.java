...
@Mixin(value = NetherBerryBush.class)
public abstract class MixinNetherBerryBush extends Block implements IFaceObstructionCheckHelper, ILeafBlock {
    ...
    /**
     * @author jss2a98aj
     * @reason  Support new leaf rendering modes on Natura leaves.
     */
    @Override
    @Overwrite
    ...
    private MixinNetherBerryBush(Material materialIn) {
        super(materialIn);
    }
